package com.learn.javaagent.Agent03.tools;

import com.google.gson.JsonArray;
import com.learn.javaagent.Agent03.runtime.TodoManager;
import com.learn.javaagent.Agent03.skills.SkillLoader;
import com.learn.javaagent.Agent03.tools.impl.*;
...
public final class ToolRegistry {
    ...
    private static final List<Tool> STANDARD_DECLARATIONS = Collections.unmodifiableList(Arrays.asList(
            ...
            new WriteFileTool(),
            new EditFileTool(),
            new LoadSkillTool(SkillLoader.getDefault()),
